 ...
 *
 *   DB_TYPE=mysql DB_HOST=localhost DB_PORT=3306 DB_NAME=reqspace DB_USER=root DB_PASSWORD=secret
 *   DB_TYPE=postgres DB_HOST=localhost DB_PORT=5432 DB_NAME=reqspace DB_USER=postgres DB_PASSWORD=pass
 *   DB_TYPE=mssql DB_HOST=localhost DB_PORT=1433 DB_NAME=reqspace DB_USER=sa DB_PASSWORD=Pass1234!
 *   DB_TYPE=mongodb MONGO_URI=mongodb://localhost:27017/reqspace
