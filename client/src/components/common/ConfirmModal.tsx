...
export const ConfirmModal: React.FC<ConfirmModalProps> = ({
  ...
  // Focus cancel button on open for safety; handle Escape key
  useEffect(() => {
    ...
    >
      ...
      >
        <div className="flex items-center gap-3 mb-4">
          <div className="bg-red-500/10 p-2 rounded-lg" aria-hidden="true">
            <AlertTriangle size={20} className="text-red-400" />
          </div>
          <h2 id="confirm-modal-title" className="text-base font-semibold text-gray-100">{title}</h2>
        </div>
        <p id="confirm-modal-description" className="text-sm text-gray-400 mb-6 leading-relaxed">{message}</p>
